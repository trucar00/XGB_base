...
train_files = [
    ...
    "../../LSTM/three_months/feats_new_rule_online/2024_7_9_feats.parquet",
    "../../LSTM/three_months/feats_new_rule_online/2024_10_12_feats.parquet",
]
...
results_csv_path = "multi_seed_results/xgb_seed_results_NEW_SPLIT_NO_CONF.csv"

# ============================================================
# Get MMSI split
# ============================================================

split_path = Path("../../split_mmsis.csv")
...
train_mmsi_r = set(saved_split.loc[saved_split["split"] == "train", "mmsi"])
val_mmsi_r = set(saved_split.loc[saved_split["split"] == "validation", "mmsi"])
test_mmsi_r = set(saved_split.loc[saved_split["split"] == "test", "mmsi"])
